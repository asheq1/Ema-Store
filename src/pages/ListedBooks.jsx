...
const ListedBooks = () => {
    ...
    <div>
        ...
        <div className=" ml-12 mr-12 border p-2">
            <div className="flex items-center space-x-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                <Link 
                    to="" 
